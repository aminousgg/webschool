      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('admin/event_edit_in', array('role' => 'form'))?>
            <!-- <form role="form" action="tambah_news" method="post"> -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="penyelenggara" class="form-control" id="exampleInputEmail1" value="<?php echo $record['penyelenggara'] ?>" placeholder="penyelenggara" required>
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Nama Event</label>
                  <input type="text" name="nama_event" class="form-control" id="exampleInputEmail1" value="<?php echo $record['nama_event'] ?>" placeholder="Event" required>
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Tempat</label>
                  <input type="text" name="tempat" class="form-control" id="exampleInputEmail1" value="<?php echo $record['tempat'] ?>" placeholder="tempat" required>
                </div>

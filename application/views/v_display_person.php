  ...
  <!-- <a href="<?php //echo base_url('login/logout'); ?>">Logout</a> -->
        ...
        <div class="row">
          <div class="col-md-4 animate-box">
            <p>Cek Kembali Data anda bila terjadi kesalahan harap melapor ke panitia pendaftaran
            dan Anda akan mendapat Username dan Kode Pendaftaran ingat baik baik username yang anda dapatkan</p>
          </div>
          <div class="col-md-4 animate-box">
